...
<ion-button color="danger" fill="clear" @click="removerTarefa(index)">Remover</ion-button>
</ion-item>
</ion-list>
</ion-content>
</ion-page>
...
import {IonPage,IonHeader,IonToolbar,IonTitle,IonContent,IonItem,IonInput,IonButton,IonList,IonLabel,IonButtons,IonBackButton} from '@ionic/vue'
import { ref } from 'vue'
